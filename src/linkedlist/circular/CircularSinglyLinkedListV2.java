...
// CSLL
public class CircularSinglyLinkedListV2 {
    NodeV5 head;
    ...
    public void addFirst(int val) {
        ...
        if (head == null) {
            ...
            head = newNode; // Make the newly created node as head node or update the head node reference as new node or Move the head node backward.
        }
    }
